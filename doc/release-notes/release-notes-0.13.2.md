Learncoin Core version 0.13.2 is now available from:

  <https://learncoin.org/bin/learncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update learncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow learncoin-tx to create v2 transactions (btcdrak)
