Learncoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/learncoin/files/Learncoin/learncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Learncoin
...
New/changed settings (command-line or learncoin.conf file)
--------------------------------------------------------
