Learncoin Core version 0.9.4 is now available from:

  https://learncoin.org/bin/0.9.4/
...
this update is incompatible with the Learncoin system and could lead to consensus
forks.

Learncoin Core released binaries from https://learncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~learncoin/+archive/ubuntu/learncoin
- A third-party or self-compiled Learncoin Core

upgrade to Learncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
