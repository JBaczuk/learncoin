Learncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/learncoin/files/Learncoin/learncoin-0.5.4/
...
http://gitorious.org/learncoin/learncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Learncoin-Qt notifications under Growl 1.3.
Increase required age of Learncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLearncoin properly when installing Learncoin-Qt over it. (Windows)
