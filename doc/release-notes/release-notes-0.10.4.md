Learncoin Core version 0.10.4 is now available from:

  <https://learncoin.org/bin/learncoin-core-0.10.4/>
...
- #6953 `43c2789` Split learncoin-tx into its own package
- #6953 `dfe0d4d` Include learncoin-tx binary on Debian/Ubuntu
