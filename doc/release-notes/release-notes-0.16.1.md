Learncoin Core version 0.16.1 is now available from:

  <https://learncoincore.org/bin/learncoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting learncoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure learncoind processes are cleaned up when tests end (sdaftuar)
