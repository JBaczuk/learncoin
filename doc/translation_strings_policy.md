...
This document provides guidelines for internationalization of the Learncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `learncoin_en.ts` remains unchanged.
