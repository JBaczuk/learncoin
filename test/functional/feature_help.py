...
"""Verify that starting learncoin with -h works as expected."""

from test_framework.test_framework import LearncoinTestFramework
from test_framework.util import assert_equal

class HelpTest(LearncoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start learncoin with -h for help text")
        ...
        self.log.info("Start learncoin with -version for version information")
        ...
        self.log.info("Start learncoind with -fakearg to make sure it does not start")
