...
# TestP2PConn: A peer we use to send messages to learncoind, and store responses.
...
class CompactBlocksTest(LearncoinTestFramework):
    ...
    # This test actually causes learncoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that learncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for learncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # learncoind will not send blocktxn responses for blocks whose height is
