...
class BIP66Test(LearncoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # learncoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and learncoind produces more specific reject
            # reasons.
