    ...
    mapper(0)
{
    ...
    ui->learncoinAtStartup->setToolTip(ui->learncoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->learncoinAtStartup->setText(ui->learncoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openLearncoinConfButton->setToolTip(ui->openLearncoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LearncoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->learncoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLearncoinConfButton_clicked()
{
