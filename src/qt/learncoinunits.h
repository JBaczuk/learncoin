...
#ifndef LEARNCOIN_QT_LEARNCOINUNITS_H
#define LEARNCOIN_QT_LEARNCOINUNITS_H
...
/** Learncoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LearncoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LearncoinUnits(QObject *parent);

    /** Learncoin units.
      @note Source: https://en.learncoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef LearncoinUnits::Unit LearncoinUnit;

#endif // LEARNCOIN_QT_LEARNCOINUNITS_H
