...
#ifndef LEARNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LEARNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LEARNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
