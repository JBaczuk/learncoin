...
static void SetupLearncoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " learncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  learncoin-tx [options] <hex-tx> [commands]  Update hex-encoded learncoin transaction\n" +
            "or:     learncoin-tx [options] -create [commands]   Create hex-encoded learncoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded learncoin transaction
