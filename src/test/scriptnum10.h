...
#ifndef LEARNCOIN_TEST_SCRIPTNUM10_H
#define LEARNCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Learncoin Core 0.10.0, for cross-comparison.
 */
public:
