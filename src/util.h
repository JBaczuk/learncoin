 ...
 */
#ifndef LEARNCOIN_UTIL_H
#define LEARNCOIN_UTIL_H
...
extern const char * const LEARNCOIN_CONF_FILENAME;
extern const char * const LEARNCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("learncoin-%s", name);
