...
#ifndef LEARNCOIN_WALLET_WALLET_H
#define LEARNCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this learncoin node, and set to 0 for transactions that were created
...
#endif // LEARNCOIN_WALLET_WALLET_H
